...
/**
 * A CARTRIDGE felelőssége az, hogy a jelzőfényespisztoly komponenseként belőle összeállítható legyen a jelzőfényespisztoly.
 */
public class Cartridge extends AlarmPistolComponent implements Pickable {
    /**
     * A tagváltozóban elmentett karakterlánc segítségével alapértelmezett, egyedi azonosítókat generálhatuk.
     */
    private static final String commonID = "cartridge";
     ...
     * Komponens típusa
     */
    private static final String type = "CARTRIDGE";
    ...
    public Cartridge(String unique){
     ...
     * @param eq az objektum, aki felveszi az patront
     * @param iu az IceUnit ahonnan felveszik az patront
     */
    @Override

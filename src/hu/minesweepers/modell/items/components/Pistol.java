...
/**
 * A Pistol felelőssége az, hogy a jelzőfényespisztoly komponenseként belőle összeállítható legyen a jelzőfényespisztoly.
 */
public class Pistol extends AlarmPistolComponent implements Pickable {

    /**
     * A tagváltozóban elmentett karakterlánc segítségével alapértelmezett, egyedi azonosítókat generálhatuk.
     */
    private static final String commonID = "pistol";
     ...
     * Komponens típusa
     */
    private static final String type = "Pistol";
     ...
     * @param eq az objektum, aki felveszi a pisztolyt
     * @param iu az IceUnit ahonnan felveszik a pisztolyt
     */
    @Override
